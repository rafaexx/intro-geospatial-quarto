...
pacman::p_load("here", "rmarkdown", "reticulate", "tidyverse", "readxl", "sf", "stars", "rnaturalearth", "mapview", "skimr", "glue", "raster", "fasterize", "purrr")
```
...
```{r}
spei <- raster::brick(here("data", "spei48.nc"))
```
